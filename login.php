                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title"><center>Users Log in</center></h4>
                            </div>
                            <div class="content">
                                


                                <form action="workers/code/login_user_code.php" method="POST">
                                    <div class="row">
                                ...
                                <div class="footer">
                                    ...
                                    <div class="stats">
                                        ...
                                        log in as users or workers of camp
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card" b>
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    <img src="assets/img/k2.jpg" height="30%" width="100%">
