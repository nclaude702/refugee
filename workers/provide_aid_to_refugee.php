                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                               ...
                               <h4 class="title"><center>COMFIRM AID TO REFUGEE</center></h4>
                                <p class="category"></p>
                            </div>
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `wait_final_received` WHERE received='not done'");
  $a->execute();
  ...
  ?>
                                        <tr>
                                            ...
                                            <td><a href="code/check_recv_code.php?id=<?php echo $wr_id ?> "><img src="../assets/img/ok.jpg"class="img"style="width:80px;height:30px;" onclick="return confirm('Are You Sure')"/></a></td>
