...
<?php
        ...
        public function stock(){
          include '../code/connection.php';
            ...
            $a->execute();
             $rice=0;$maize=0;$beans=0;$oil=0;$others=0;$flour=0;
             $qflour=0;$qothers=0;$qoil=0;$qbeans=0;$qmaize=0;$qrice=0;
                while($row=$a->fetch(PDO::FETCH_ASSOC)){
                    $food_id=$row['food_id'];
...
?>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Welcome to <b>user refugee Management System Dashboard</b>."
