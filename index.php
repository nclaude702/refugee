                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                <h5 class="title"><center>SIMPLE INFORMATION IN KIGEME REFUGEE CAMP</center></h5>
                            </div>
...
?>
                    ...
                    <div class="col-md-8">
                     ...
                     <img src="assets/img/k1.jpg" height="550px" width="700px">
                      </div>
                    </div>
                </div>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Welcome to <b>Kigeme refugees System</b>."
