...
<div class="wrapper">
    <div class="sidebar" data-color="violet" data-image="assets/img/sidebar-5.jpg">
...
<?php 
      try{
         ...
         $a=$con->prepare("SELECT * FROM `users_leader` where h_id='$uid'");
         $a->execute();
  ...
  ?>
                            <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label><input type="text" name="region"value="<?php echo $region; ?>" readonly></label>
                                ...
                                <form action="code/update_profile_code.php" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>TYPE</label>
                                                <input type="text" name="region" class="form-control" value="<?php echo $region; ?>" readonly>
                                            </div>
                                        </div>
