...
if (isset($_SESSION['h_id'])) {
   $uid=$_SESSION['h_id']; $leader_name=$_SESSION['lname']; $username=$_SESSION['username']; ?>
<!doctype html>
<html lang="en">
<head>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="add" class="form-control" value="<?php echo $leader_name; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
   ...
   class daily_info{ 
    function __construct(){ 
      try{ 
         ...
         $a=$con->prepare("SELECT * FROM `daily_info` order by id DESC limit 5");
         $a->execute();
...
?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    <span><b><textarea name="msg" class="form-control">
                                        

                                    </textarea> </b> 
                                     </b></span>
                                      <font color="violet">
                                     <input type="text" name="name_add" value="<?php echo $username; ?>"  readonly></font>
