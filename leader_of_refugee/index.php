                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">SIMPLE REPORT</h4>
...
?>
                    ...
                    <div class="col-md-8">
                        <img src="../assets/img/4.png" height="480px" width="700px">
                    </div>
                </div>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Welcome to <b>index refugees managements System Dashboard</b>."
